...
from .generic import GeneralInterface
from .import_utils import is_torch_flex_attn_available, is_torch_greater_or_equal, is_tracing
...
def _preprocess_mask_arguments(
    ...
    if past_key_values is not None:
        if hasattr(past_key_values, "get_mask_sizes"):
            ...
            kv_length = past_key_values.get_seq_length(layer_idx) + cache_position.shape[0]
            kv_offset = 0
